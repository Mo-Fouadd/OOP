...
class GroceryList {
     ArrayList<GroceryItemOrder> orders = new ArrayList<GroceryItemOrder>();
     //int sizeOfList= orders.size();
    public GroceryList(){}
...
class GroceryItemOrder{
    //an item name, quantity and a price per unit.
    String name;
    int quantity;
    double pricePerUnit;
